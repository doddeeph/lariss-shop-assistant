...
class ProductResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("rel_product__variant").block();
    ...
    @Test
    void checkSpecialPriceIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
    ...
    void getAllProducts() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].specialPrice")
            .value(hasItem(sameNumber(DEFAULT_SPECIAL_PRICE)))
            .jsonPath("$.[*].quantity")
    ...
    void getProduct() {
        ...
        webTestClient
            ...
            .jsonPath("$.specialPrice")
            .value(is(sameNumber(DEFAULT_SPECIAL_PRICE)))
            .jsonPath("$.quantity")
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).sku(UPDATED_SKU).specialPrice(UPDATED_SPECIAL_PRICE);
