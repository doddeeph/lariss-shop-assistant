...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("id.lariss.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("id.lariss.security.DomainUserDetailsService", "createSpringSecurityUser");
