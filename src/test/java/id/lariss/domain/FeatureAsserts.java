...
public class FeatureAsserts {
    ...
    public static void assertFeatureUpdatableFieldsEquals(Feature expected, Feature actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getFeatureEn()).as("check featureEn").isEqualTo(actual.getFeatureEn()))
            .satisfies(e -> assertThat(e.getFeatureId()).as("check featureId").isEqualTo(actual.getFeatureId()));
    }
