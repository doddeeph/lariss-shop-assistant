...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e ->
                assertThat(e.getSpecialPrice())
                    .as("check specialPrice")
                    .usingComparator(bigDecimalCompareTo)
                    .isEqualTo(actual.getSpecialPrice())
            )
    ...
    public static void assertProductUpdatableRelationshipsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getVariants()).as("check variants").isEqualTo(actual.getVariants()));
    }
}
