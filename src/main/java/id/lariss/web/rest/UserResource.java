...
import id.lariss.config.Constants;
import id.lariss.domain.User;
import id.lariss.repository.UserRepository;
import id.lariss.security.AuthoritiesConstants;
import id.lariss.service.MailService;
import id.lariss.service.UserService;
import id.lariss.service.dto.AdminUserDTO;
import id.lariss.web.rest.errors.BadRequestAlertException;
import id.lariss.web.rest.errors.EmailAlreadyUsedException;
import id.lariss.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link id.lariss.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
