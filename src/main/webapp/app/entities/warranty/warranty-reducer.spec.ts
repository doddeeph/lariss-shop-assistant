...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './warranty.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WARRANTY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WARRANTY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WARRANTY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WARRANTY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WARRANTY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WARRANTY actions', async () => {
      const arg = 42666;
