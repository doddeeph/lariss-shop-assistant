...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './memory.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEMORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEMORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEMORY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEMORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEMORY actions', async () => {
      const arg = 42666;
