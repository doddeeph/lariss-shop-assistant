...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './color.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COLOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COLOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COLOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COLOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COLOR actions', async () => {
      const arg = 42666;
