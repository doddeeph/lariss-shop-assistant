...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './processor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROCESSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROCESSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROCESSOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROCESSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROCESSOR actions', async () => {
      const arg = 42666;
