...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="larissShopAssistantApp.product.delete.question">
        <Translate contentKey="larissShopAssistantApp.product.delete.question" interpolate={{ id: productEntity.id }}>
