...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DESCRIPTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DESCRIPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESCRIPTION actions', async () => {
      const arg = 42666;
