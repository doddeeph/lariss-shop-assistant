...
export const CategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="larissShopAssistantApp.category.delete.question">
        <Translate contentKey="larissShopAssistantApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
