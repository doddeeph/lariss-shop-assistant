...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOXCONTENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOXCONTENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOXCONTENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BOXCONTENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BOXCONTENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOXCONTENT actions', async () => {
      const arg = 42666;
