...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './variant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIANT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VARIANT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VARIANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VARIANT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VARIANT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VARIANT actions', async () => {
      const arg = 42666;
