...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './feature.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FEATURE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FEATURE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FEATURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FEATURE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FEATURE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FEATURE actions', async () => {
      const arg = 42666;
