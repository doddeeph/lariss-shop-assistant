...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './storage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STORAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STORAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_STORAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_STORAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STORAGE actions', async () => {
      const arg = 42666;
